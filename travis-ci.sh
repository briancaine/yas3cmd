...
export OPAM_PACKAGES='ocamlfind ounit oasis core ppx_deriving ppx_fields_conv ppx_sexp_conv cohttp base64 nocrypto oasis bisect_ppx ocveralls lwt xml-light'
